...
@ManagedBean
public class MindmapViewCobaCobi implements Serializable {
    
    private MindmapNode root;
    
    private MindmapNode selectedNode;
    
    public MindmapViewCobaCobi() {
//        root = new DefaultMindmapNode("google.com", "Google WebSite", "FFCC00", false);
        root = new DefaultMindmapNode("Ajax Core", "Ajax Framework - Listener", "FFCC00", false);
...
//        MindmapNode malware = new DefaultMindmapNode("Malware", "Malicious Software", "6e9ebf", true);
        ...
        MindmapNode listener = new DefaultMindmapNode("listener.xhtml", "ListenerView.java", "6e9ebf", true);
        MindmapNode partialSubmit = new DefaultMindmapNode("partialSubmit.xhtml", "PartialSubmit.java", "6e9ebf", true);
        MindmapNode counter = new DefaultMindmapNode("counter.xhtml", "PartialSubmit.java", "6e9ebf", true);

        root.addNode(listener);
        root.addNode(partialSubmit);
